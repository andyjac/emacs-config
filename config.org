...
*** window
#+BEGIN_SRC emacs-lisp
  (defun hydra-window-find-file (arg)
    (interactive "P")
  ...
  (defhydra hydra-window (:color red :hint nil)
    "
  _o_: ace-window          _0_: delete-window        _h_: windmove-left  _F_: toggle-frame-fullscreen
  ...
  _s_: ace-swap-window     _3_: split-window-right   _k_: windmove-up    _f_: find-file
