...
#+END_SRC
* Font
Install [[https://adobe-fonts.github.io/source-code-pro/][Source Code Pro]].
...
#+END_SRC
*** Go
Install the ~go~ [[https://golang.org/dl/][programming language and tools]] and add ~$GOPATH/bin~ to your ~$PATH~ var.
